...
dftrain = pd.read_csv('https://raw.githubusercontent.com/Vise-Up/Linear_Regression/main/insurance_train.csv')
dfeval = pd.read_csv('https://raw.githubusercontent.com/Vise-Up/Linear_Regression/main/insurance_eval.csv')
